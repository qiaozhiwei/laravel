...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        ...
        <form method="post" class="layui-form" action="<?php echo e(url('user/dologin')); ?>">
            ...
            <hr class="hr15">
            <img src="http://www.laravel.com/user/get_code">
            <hr class="hr15">
...
</html><?php /**PATH C:\wnmp\www\laravel\resources\views/user/login.blade.php ENDPATH**/ ?>