    ...
    <div class="section product">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col s6">
					<div class="content">
						<img src="<?php echo e($item->goods_pic); ?>" width="100px;" height="100px;" class="pdd" id="<?php echo e($item->id); ?>">
						<h6><a href=""><?php echo e($item->goods_name); ?></a></h6>
						<div class="price">
							$20 <span>$<?php echo e($item->goods_price); ?></span>
						</div>
    ...
    <div class="section product">
		<div class="container">
            ...
            <?php $__currentLoopData = $arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="col s6">
					<div class="content">
						<img src="<?php echo e($v->goods_pic); ?>" width="100px;" htight="100px;" class="pdd" id="<?php echo e($v->id); ?>">
						<h6><a href=""><?php echo e($v->goods_name); ?></a></h6>
						<div class="price">
							$20 <span>$<?php echo e($v->goods_price); ?></span>
						</div>
						<button class="btn button-default">ADD TO CART</button>
					</div>
				</div>
...
<script>
    $(function(){
        $('.pdd').click(function(){
            ...
            location.href="<?php echo e(url('Index/pro')); ?>?id="+id;
        });
    });
</script>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layout.parent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wnmp\www\laravel\resources\views/aindex.blade.php ENDPATH**/ ?>