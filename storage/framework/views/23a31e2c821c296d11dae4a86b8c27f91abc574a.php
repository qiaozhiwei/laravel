            ...
            $.get(
                ...
                function(res){
                    ...
                    if(res.code==200){
                        ...
                        location.href="<?php echo e(url('member/update')); ?>?data="+array; 
                    }else{
                        alert(res.msg);
                    }
                },
...
</html><?php /**PATH C:\wnmp\www\laravel\resources\views/member_index.blade.php ENDPATH**/ ?>